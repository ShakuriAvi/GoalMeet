...
* User who wants to join the soccer team.
...
Through chat users can determine where and when to meet, check if the message read or not and talk with different users.
...
# User profile
A user can edit his profile at any time but, when he is on another user's profile he --has no-- permissions to edit this profile.
...
# Clicking on CreateTeam

Allows the user to open a new team, add players, select the team name,write description of the team and choose logo. 
...
# Clicking on chat
Displays all the people the user has talked with them and their status (online or offline).
